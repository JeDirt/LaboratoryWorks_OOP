...
public abstract class DrawShape
{
    ...
    public static DrawShape newInstance(int shapeType)
    {
        ...
        if (shapeType == DrawShape.SHAPE_RECTANGLE) { shape = new Rectangle();}

        else if (shapeType == DrawShape.SHAPE_ROUNDED_RECT) { shape = new RoundedRectangle();}

        else if (shapeType == DrawShape.SHAPE_ELLIPSE) { shape = new Ellipse();}
